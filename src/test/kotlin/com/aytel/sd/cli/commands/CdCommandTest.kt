...
class CdCommandTest {
    ...
    fun fromArgs() {
        ...
        val oldPath: String = environment.getPath().toString()
        ...
        assertEquals("$oldPath/src/test/resources", environment.getPath().toString())
    }
    ...
    fun nonexistentDirectory() {
        ...
        assertEquals(oldPath, environment.getPath().toString())
    }
    ...
    fun severalCds() {
        ...
        assertEquals("$oldPath/src/test", environment.getPath().toString())
    }
}